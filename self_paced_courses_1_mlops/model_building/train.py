...
Xtrain_path = "hf://datasets/jmgenai1/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/jmgenai1/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/jmgenai1/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/jmgenai1/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
...
param_grid = {
    'gradientboostingclassifier__n_estimators': [75, 100, 200],
...
repo_id = "jmgenai1/PIMA-Diabetes-Prediction"                                         # enter the Hugging Face username here
repo_type = "model"
